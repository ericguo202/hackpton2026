...
- **`_helpers.ts`** — `SCORE_KEYS`, `SCORE_COLOR_MAP`, `num()`, `turnAverage()`, `improvementMomentsOf()`. All derive from `lib/scoreDimensions.ts` (STAR default set).
