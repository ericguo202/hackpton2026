 ...
 * devices/MFA/delete) and injects two custom pages, Privacy
 * (`PrivacySettings`) and Pricing (`PricingSettings`). Reached from the avatar
 * menu's "Manage account" (AccountButton wires `userProfileUrl="/settings"`).
 *
 ...
 * provider in Root.tsx sits outside BrowserRouter). Custom pages append after
 * the defaults in child order, so the sidenav reads Account, Security, Privacy,
 * Pricing.
 *
