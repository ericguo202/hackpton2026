...
async def create_session_feedback(
    ...
    feedback = SessionFeedback(
        ...
        features_used=body.features_used.strip(),
        features_helpful=_clean_optional(body.features_helpful),
        desired_features=_clean_optional(body.desired_features),
        difficult_feature_response=_clean_optional(body.difficult_feature_response),
