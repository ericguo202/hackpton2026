...
def upgrade() -> None:
    op.create_table(
        ...
        sa.Column("smoothness_rating", sa.Integer(), nullable=False),
        sa.Column("desired_features", sa.Text(), nullable=True),
        sa.Column("question_relevance_rating", sa.Integer(), nullable=False),
        sa.Column("feedback_helpfulness_rating", sa.Integer(), nullable=False),
        sa.Column("feedback_specificity", sa.Text(), nullable=True),
        sa.Column("bug_report", sa.Text(), nullable=True),
        sa.Column("pay_likelihood_rating", sa.Integer(), nullable=False),
