...
face_calibration_consent_at TIMESTAMPTZ NULL, face_calibration_consent_version INT NULL, face_calibration_revoked_at TIMESTAMPTZ NULL,  -- server-side calibration consent (migration 0020); profile stays client-side, namespaced per user
